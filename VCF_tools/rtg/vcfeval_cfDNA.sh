...
#SBATCH --output=rtg_cfDNAvUltima_%j.out
#SBATCH --error=rtg_cfDNAvUltima_%j.err
...
ULTIMA_DIR=/cluster/projects/pughlab/myeloma/projects/MM_cell_drugs/WGS_Pipeline/UGBIODocker/sample/Ultima_cfDNA
ILLUMINA_DIR=/cluster/projects/pughlab/myeloma/projects/MM_cell_drugs/WGS_Pipeline/UGBIODocker/sample/Illumina_cfDNA
BED_REGIONS=/cluster/projects/pughlab/references/Ultima/SRSNV/ug_hcr.bed
OUTDIR=/cluster/projects/pughlab/myeloma/projects/MM_cell_drugs/WGS_Pipeline/UGBIODocker/sample/vcfeval_results_cfDNA
mkdir -p "$OUTDIR"
