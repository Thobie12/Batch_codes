...
echo "DEBUG: MEAN_COVERAGE = '$MEAN_COVERAGE'"
# =========================
# Step 2: snvfind
# =========================
...
#this created the .clean file used for the parquet generation
...
#  --out $OUTPUT_DIR/${BASE}.rawFP.filtered.parquet \
...
#also did exact cleaning as in step 3 here to ensure the files are similarly processed
